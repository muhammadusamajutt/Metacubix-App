...
const testimonials = [
    ...
    },
    {
        ...
        text: "I had my concerns that due to a tight deadline this project can't be done. But this guy proved me wrong not only he delivered outstanding work but he managed to deliver 1 day prior to the deadline. And when I asked for some revisions he made them in MINUTES. I'm looking forward to working with him again and I totally recommend him. Thanks again!"
    },
    {
        name: "Sasha Ho",
        position: "Accountant",
        ...
        <>
            ...
            <div className="testimonials">
                <div className="testimonials-container container">
                    <FontAwesomeIcon icon={faQuoteRightAlt} className="fa-quote fa-quote-right" />
                    <FontAwesomeIcon icon={faQuoteLeftAlt} className="fa-quote fa-quote-left" />
